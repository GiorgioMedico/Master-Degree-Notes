...
\draw[->] (0,0) -- (0,2) node[above] {$x_t^{\text{traj}}$};
\draw[red, thick] (0,1.5) to[out=0,in=180] (2,1.2) to[out=0,in=180] (5,1.2);
\end{tikzpicture}
\end{center}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{mpc1.png}
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{mpc2.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{mpc3.png}
    \label{fig:mpc3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{mpc4.png}
    \label{fig:mpc4}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{mpc5.png}
    \label{fig:mpc5}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{mpc6.png}
    \label{fig:mpc6}
\end{figure}
...
\begin{figure}[ht]
    ...
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{mpc7.png}
        \label{fig:mpc7}
    \end{minipage}
    \hfill
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{mpc8.png}
        \label{fig:mpc8}
    \end{minipage}
    \hfill
    \begin{minipage}{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{mpc9.png}
        \label{fig:mpc9}
    \end{minipage}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{di_unconstr}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{di_input_constr}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{di_state_constr}
...
\Until{$\|V^k - V^{k-1}\|_\infty < \varepsilon$}
\State \Return $V^k$
\end{algorithmic}
\end{algorithm}
...
\Repeat
    ...
    \State $k \leftarrow k + 1$
\Until{$\|V_{\pi^k} - V_{\pi^{k-1}}\|_\infty < \varepsilon$}
\State \Return $\pi^k$
\end{algorithmic}
\end{algorithm}
