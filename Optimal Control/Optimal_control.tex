%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Document Class
% 'openany' allows chapters to begin on any page, not just right-hand pages
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[openany]{book}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Language and Page Layout
% - babel: Provides language-specific typesetting rules
% - geometry: Handles page dimensions and margins
% - setspace: Controls line spacing
% - microtype: Improves typography with micro-adjustments
% - parskip: Manages paragraph spacing and indentation
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[english]{babel}
\usepackage{geometry}
\geometry{
    a4paper,              % Standard A4 paper size
    total={170mm,237mm},  % Total text area dimensions
    left=20mm,            % Left margin
    top=30mm,             % Top margin
    heightrounded         % Rounds text height to integer number of lines
}
\usepackage{setspace}
\onehalfspacing          % Sets 1.5 line spacing throughout document
...
% - amsmath: Advanced mathematical formatting
...
\usepackage{amsfonts}
\usepackage{bm}
\allowdisplaybreaks[1]   % Allows page breaks in math displays

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Graphics and Figures
% - graphicx: Handles image inclusion
% - float: Improves floating environment
% - tikz: Drawing tools for diagrams
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{graphicx}
\usepackage{float}
\usepackage{tikz}
...
% - hyperref: Creates clickable links and references
% - fancyhdr: Customizes headers and footers
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[hidelinks]{hyperref}    % Creates links without colored borders
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}                          % Clears all headers and footers
\renewcommand{\headrulewidth}{0pt}  % Removes header line
\fancyfoot[C]{\thepage}             % Centers page number in footer
\setlength{\footskip}{50pt}         % Space between text and footer

% Page breaking improvements
\raggedbottom                       % Allows flexible page breaks
\emergencystretch=1em              % Extra stretch space for line breaking
\tolerance=1000                     % Increases tolerance for suboptimal breaks
\pretolerance=100                  % Initial attempt without hyphenation

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Mathematical Operators and Commands
% Custom commands for frequently used mathematical notation
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand\at[2]{\left.#1\right|_{#2}}    % Function evaluation
...
% Defines various theorem-like environments with consistent styling
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\widowpenalty=10000     % Prevents widow lines (last line of paragraph on new page)
\clubpenalty=10000      % Prevents orphan lines (first line of paragraph at bottom of page)
\brokenpenalty=10000    % Penalizes page breaks after hyphenated lines
